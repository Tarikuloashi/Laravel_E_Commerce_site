		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox"  id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
						<ul>
					...
					<li><input type="checkbox" id="item-1"  /><label for="item-1">Best Collections</label>
						<ul>
					...
					<li><input type="checkbox"  id="item-2" /><label for="item-2">Best Offers</label>
						<ul>
...
<!--
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					...
					<p>Discover men's fashion exclusives with ASOS. Choose from limited editions 
					of men's t-shirts, shoes and jackets. Shop exclusive collection at ASOS today.
					With its grained leather and topstitching done with contrasted colours, the 
					small leather product Marius is made for young men in search of a dash of 
					modernity.Created in association with visionary Mark Hollis and 
					award-winning jewelry designer. Charles P. Bahringer, the HOLLIS 
					BAHRINGER collection.</p>
				</div>
				<div class="clearfix"></div>
			</div>
			<!--
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{asset($publishedCategoryProduct->productImage)}}" width="255px" height="291px" alt="" class="pro-image-front">
						<img src="{{asset($publishedCategoryProduct->productImage)}}" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="{{url('/productdetails/'.$publishedCategoryProduct->id)}}" class="link-product-add-cart">Quick View</a>
								</div>
							</div>
							<span class="product-new-top">New</span>				
					</div>
					<div class="item-info-product ">
						<h4><a href="{{url('/productdetails/'.$publishedCategoryProduct->id)}}">{{$publishedCategoryProduct->productName}}</a></h4>
						<div class="info-product-price">
