	...
	<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					...
					<li><img class="img-responsive" src="{{asset('public/frontEnd/images/ba4.jpg')}}" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="{{asset('public/frontEnd/images/ba5.jpg')}}" alt="Dummy Image" /></li>
				</ul>
				...
				<div class="script-wrap">
					<ul class="script-group">
						...
						<li><div class="inner-script"><img class="img-responsive" src="{{asset('public/frontEnd/images/baa4.jpg')}}" alt="Dummy Image" /></div></li>
					</ul>
		...
		<div class="new_grids">
			<div class="col-md-4 new-gd-left">
				...
				<div class="wed-brand simpleCart_shelfItem">
					...
					<h5> 50% Discount</h5>
				<!--	<p><i>$600</i> <span class="item_price">$300</span><a class="item_add hvr-outline-out button2" href="#">add to cart </a></p> -->
				</div>
			</div>
...
<div class="content-bottom">
	<div class="col-md-7 content-lgrid">
		...
		<div class="col-sm-6 content-img-right">
			<h3>Special Offers and 50%<span>Discount On</span> Iphone</h3>
		</div>
		
		<div class="col-sm-6 content-img-right">
			<h3>Buy 1 get 1  free on <span> Apple Product</span> Laptop</h3>
		</div>
		<div class="col-sm-6 content-img-left text-center">
			<div class="content-grid-effect slow-zoom vertical">
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($publishedProduct->productImage)}}" width="255px" height="291px" alt="" class="pro-image-front">
								...
								<div class="item-info-product ">
									<h4><a href="{{url('/productdetails/'.$publishedProduct->id)}}">{{$publishedProduct->productName}}</a></h4>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<img src="{{asset('public/frontEnd/images/mw1.png')}}mw1.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
